...
// Admin-specific agents
export const adminAgents: Agent[] = [
    {
        id: 'admin-linkedin',
        name: 'LinkedIn Post Creator',
        description: 'Create engaging LinkedIn posts for your business',
        icon: (
            <svg viewBox="0 0 24 24" className="w-5 h-5 text-[#0A66C2] fill-current">
...
// Create a wrapper component that includes allowedTypes
