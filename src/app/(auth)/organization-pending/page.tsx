            ...
            <div className="max-w-lg w-full space-y-8 p-8 bg-white rounded-lg shadow-lg">
                <div className="text-center">
                    ...
                    <div className="space-y-4 text-gray-600 mb-8">
                        <p>
                            Your request to set up {orgName ? <span className="font-semibold">{orgName}</span> : 'your organization'} on 
                            Exlayr AI has been submitted and is pending approval.
                        </p>
                        <p>
                            Our team is reviewing your application and verifying the provided information. 
