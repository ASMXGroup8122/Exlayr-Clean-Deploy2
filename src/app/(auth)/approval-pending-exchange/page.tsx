...
export default function ApprovalPendingExchange() {
    ...
    useEffect(() => {
        const fetchExchangeDetails = async () => {
            ...
            try {
                ...
                if (org) {
                    setOrgName(org.exchange_name);
                }
            } catch (error) {
                console.error('Error in fetchExchangeDetails:', error);
            }
        };
            ...
            <div className="max-w-lg w-full space-y-8 p-8 bg-white rounded-lg shadow-lg">
                <div className="text-center">
                    <h1 className="text-2xl font-bold text-gray-900 mb-4" suppressHydrationWarning>
                        Exchange Membership Pending
                    </h1>
                    <div className="space-y-4 text-gray-600 mb-8">
                        <p suppressHydrationWarning>
                            Thank you for registering with {orgName ? <span className="font-semibold">{orgName}</span> : 'the exchange'}.
                        </p>
                        <p suppressHydrationWarning>
                            Your membership request is now pending approval from the exchange administrators.
                            You will receive an email notification when your membership is approved.
                        </p>
                        <p suppressHydrationWarning>
                            Once approved, you'll have access to the exchange dashboard and all its features.
                        </p>
                    </div>
